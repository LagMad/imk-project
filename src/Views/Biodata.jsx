...
const Biodata = () => {
    ...
    return (
        <div className="flex flex-col min-h-screen min-w-full font-poppins font-bold text-center text-xl justify-center items-center gap-4">
            <div className='w-[95vw] sm:w-auto text-2xl sm:text-3xl font-black text-white bg-cust-darker-blue hover:bg-cust-orange py-5 px-5 sm:px-36 rounded-full mt-24'>
                DETAIL BIODATA MAHASISWA
            </div>
            <div className='flex flex-col sm:flex-row w-[95vw] sm:w-auto bg-cust-darker-blue text-white p-8 rounded-3xl gap-10 justify-center items-center'>
                <img
                    className=''
                    src={Photo}
                    alt='missing img'
